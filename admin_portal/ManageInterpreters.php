...
EOF;*/
		...
		//I'm a bit worried about how the javascript from Mate and the scheduler libraries will interact
		//(especially considering the way mate does navigation)
		//so I'm using iframes for now to keep things separate.
		$html = <<<EOF
